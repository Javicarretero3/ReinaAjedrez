...
public class Consola {
	...
	public static Direccion elegirDireccion() {
		...
		int elegirdireccion;
		do {
			System.out.print("Escriba un número entre 1 y 8 para la direccion en la que desee moverse: ");
	...
	public static int elegirPasos() {
		...
		do {
			System.out.print(
					"Escriba la cantidad de pasos entre 1 y 7 que desee que se mueva su reina: ");
